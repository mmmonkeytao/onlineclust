/*
 * @(#)mwutil.h    generated by: makeheader 5.1.5  Mon Jun 28 17:07:37 2010
 *
...
#define _mwfirst(X, Y) X
#define _mwsecond(X, Y) Y

#define _define_module_tables(language_and_table, m) \
  _define_module_tables_(_mwfirst language_and_table, _mwsecond language_and_table, m)
#define _define_module_code_strings(language_and_table, m) \
  _define_module_code_strings_(_mwfirst language_and_table, _mwsecond language_and_table, m)

#define _table_element_(language, table, m) _concat(table,_strings_,m),

#define _table_element(language_and_table, m) \
  _table_element_(_mwfirst language_and_table, _mwsecond language_and_table, m)

#define _values_element_(language, table, m) _concat(table,_codes_,m),

#define _values_element(language_and_table, m) \
  _values_element_(_mwfirst language_and_table, _mwsecond language_and_table, m)
...
#define _values_string_element(language_and_table, m) \
  _values_string_element_(_mwfirst language_and_table, _mwsecond language_and_table, m)
